...
export const metadata: Metadata = {
    title: 'About Trifusion Technology — Premium Software Engineering & Digital Platform Partner',
    description: 'Learn about Trifusion Technology LLP, our engineering culture, mission, and how we build digital products for scaling enterprises.',
};
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-lg text-slate-500 max-w-2xl leading-relaxed">
                            Trifusion Technology LLP is a full-service software engineering firm. We design, build, and scale custom software, SaaS products, mobile applications, and AI-powered business systems.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="section bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        ...
                        <h2 className="text-3xl sm:text-4xl font-bold text-[#0B1F4A] mt-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            <section className="section bg-[#F9FAFB] border-t border-slate-100 text-center">
                <div className="max-w-3xl mx-auto px-4">
                    <h2 className="text-3xl font-bold text-[#0B1F4A] mb-4" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                        Partner with Trifusion Technology
                    </h2>
                    <p className="text-slate-500 mb-8">
                        Ready to elevate your software engineering? Let&apos;s discuss your roadmap.
                    </p>
