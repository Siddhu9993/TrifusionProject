...
const fallbackServices = [
    ...
    { id: '4', slug: 'saas-product-development', title: 'SaaS Product Development', shortDesc: 'End-to-end SaaS engineering from architecture to go-to-market.', icon: 'layers', published: true, featured: true, sortOrder: 3 },
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-12">
                    <div>
                        ...
                        <p className="mt-3 text-slate-500 max-w-xl">
                            From greenfield product development to complex systems integration — we cover the full spectrum of modern software engineering.
                        </p>
                    </div>
