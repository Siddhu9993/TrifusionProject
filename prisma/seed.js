...
async function main() {
    ...
    const hashedPassword = await bcryptjs_1.default.hash(adminPass, 12);
    ...
    const servicesData = [
        ...
        },
        {
            ...
            shortDesc: 'End-to-end SaaS product engineering from architecture to go-to-market.',
            description: 'We help founders and product teams build SaaS products that are architected for multi-tenancy, subscription billing, onboarding flows, and sustainable growth from day one.',
            icon: 'layers',
